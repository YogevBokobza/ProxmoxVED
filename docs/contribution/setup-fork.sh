...
# upstream   https://github.com/YogevBokobza/ProxmoxVED.git (fetch)
# upstream   https://github.com/YogevBokobza/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/YogevBokobza/ProxmoxVED"
echo ""
